...
public class MainModel {
	...
	public MainModel() {
		try {
			...
			FileReader readerDynasty = new FileReader("oop/src/main/json/Dynasty.json");
			...
			FileReader readerFestival = new FileReader("oop/src/main/json/Festival.json");
			...
			FileReader readerEvent = new FileReader("oop/src/main/json/Event.json");
			...
			FileReader readerFigure = new FileReader("oop/src/main/json/Figures.json");
			...
			King kingTemp[] = null;
			FileReader readerKing = new FileReader("oop/src/main/json/Kings.json");
			...
			FileReader readerRelic = new FileReader("oop/src/main/json/Relic.json");
